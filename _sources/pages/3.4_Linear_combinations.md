...
::::{prf:example}
:label: basis-vectors-example

Represent the following vectors as linear combination of the basis vectors $\mathbf{i}$, $\mathbf{j}$ and $\mathbf{k}$

&emsp; (i) &emsp; $\begin{pmatrix} 2 \\ 5 \\ 3 \end{pmatrix}$;

:::{dropdown} Solution
$$ \begin{pmatrix} 2 \\ 5 \\ 3 \end{pmatrix} = 2 \mathbf{i} + 5 \mathbf{j} + 3 \mathbf{k} $$
:::

&emsp; (ii) &emsp; $3\begin{pmatrix} 1 \\ 0 \\ 2 \end{pmatrix}$.

:::{dropdown} Solution
$$ 3\begin{pmatrix} 1 \\ 0 \\ 2 \end{pmatrix} = 3(\mathbf{i} + 0 \mathbf{j} + 2 \mathbf{k}) = 3 \mathbf{i} + 6 \mathbf{k} $$
:::
::::
