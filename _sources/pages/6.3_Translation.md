...
Expressing $\mathbf{u} = (2,3)$ using homogeneous co-ordinates we have $\mathbf{u} = (2,3,1)$. The translation matrix is
...
so expressed in Cartesian co-ordinates we have $T(3,-1) \cdot \mathbf{u} = (5,2)$.
...
::::{dropdown} Solution
The homogeneous vertex co-ordinates are $(-1, -1, 1)$, $(1, -1, 1)$ and $(0, 2, 1)$ and can be combined in the single matrix
...
$$ \begin{align*}
    A &= T(6, 4) \cdot Rot(\pi/4) \cdot S(2,2) \\
    &= \begin{pmatrix}
        0 & 2 \sqrt{2} & -2\sqrt{2} \\
        -2\sqrt{2} & 0 & 2\sqrt{2} \\
        1 & 1 & 1
