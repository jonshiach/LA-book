...
%     \draw [help lines] (330:1.5) -- ++(30:1) -- ++(150:1.5) -- ++(210:1)
...
%     \draw [vector, blue!20] (0, 0) -- (1) node [pos=0.75,above left] {$\mathbf{u}$};
%     \node [point, blue] at (\a2-\a1:\l1) (1) {};
%     \draw [vector] (0, 0) -- (1) node [pos=0.75,above left] {$\mathbf{u}$};
%     \draw [dashed, line width=2pt] ({180}:\l2) -- (0:\l1);
%     \draw [dashed, line width=2pt, black!20] (\a1+180:\l2) -- (\a1:{1.25*\l1});
%     \draw [-latex'] (\a1:\l2) arc (\a1:0:\l2);
%     \draw [-latex'] (\a2:1.25*\l2) arc (\a2:\a2-\a1:1.25*\l2);
%     \node at (0.5*\a1:0.75) {$\theta$};
% \end{tikzpicture}
...
%     \draw [vector] (0, 0) -- (1) node [pos=0.75,above left] {$\mathbf{u}$};
%     \draw [vector, red] (0, 0) -- (2) node [pos=0.75,below left] {$\mathbf{v}$};
%     \draw [dashed, line width=2pt] ({180}:\l2) -- (0:{\l1+0.4});
%     \draw [-latex'] (1) -- (2);
% \end{tikzpicture}
...
%     \draw [vector, blue!20] (0, 0) -- (1) node [pos=0.75,above left] {$\mathbf{u}$};
%     \draw [vector, red!20] (0, 0) -- (2) node [pos=0.75,below left] {$\mathbf{v}$};
%     % \draw [dashed, line width=2pt, black!10] ({180}:\l2) -- (0:\l1);
%     \draw [dashed, line width=2pt] (\a1+180:\l2) -- (\a1:{1.25*\l1});
%     % \draw [latex'-] (90-\a2:0.75*\l2) arc (90-\a2:90-\a2-\a1:0.75*\l2);
%     \draw [latex'-] (\a1:\l2) arc (\a1:0:\l2);
%     % \draw [latex'-] (\a2:1.25*\l2) arc (\a2:\a2-\a1:1.25*\l2);
%     \draw [dashed, line width=2pt, black!20] ({180}:\l2) -- (0:{\l1+0.4});
% \end{tikzpicture}
