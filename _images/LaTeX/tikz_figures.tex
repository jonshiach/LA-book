...
% R3
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\al=3;\lx=2;\ly=1;\lz=1;}
...
% R3 vector
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\al=2;\lx=2;\ly=1;\lz=1;}
%     \draw [axis] (0,0) -- ++(\x:\al) node at (\x:\al+0.2) {$x$};
%     \draw [axis] (0,0) -- ++(\y:\al) node at (\y:\al+0.2) {$y$};
%     \draw [axis] (0,0) -- ++(\z:\al) node at (\z:\al+0.2) {$z$};
%     \coordinate (1) at ($(\x:2)+(\y:1)$);
...
% % Position vector
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\al=2;\lx=2;\ly=2;\lz=1;}
%     \draw [axis] (0,0) -- ++(\x:\al) node at (\x:\al+0.2) {$x$};
%     \draw [axis] (0,0) -- ++(\y:\al) node at (\y:\al+0.2) {$y$};
%     \draw [axis] (0,0) -- ++(\z:\al) node at (\z:\al+0.2) {$z$};
%     \node [below] at (0, 0) (O) {$(0,0,0)$};
%     \node [point,label=right:{$(x,y,z)$}] at (30:4) (P) {};
%     \draw [vector]  (0, 0) -- node [below right] {$\vec{p}=(x,y,z)$} (P);
% \end{tikzpicture}
...
% % Cross product
% \begin{tikzpicture}
%     \tikzmath{\a=0;\b=45;\axb=90;\bxa=\axb+180;}
%     \draw [vector] (0,0) -- (\a:3) node [pos=0.75,below left] {$\vec{a}$} ;
%     \draw [vector, red] (0,0) -- (\b:3) node [pos=0.75,above left] {$\vec{b}$};
%     \draw [vector, green!75!black] (0, 0) -- node [left] {$\vec{a}\times \vec{b}$} ++(\axb:2);
%     \draw [vector, black] (0, 0) -- node [left] {$\vec{b}\times \vec{a}$} ++(\bxa:2);
...
% Basis vectors
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\al=3;\lx=1.5;\ly=1;\lz=2;}
%     \draw [axis] (0,0) -- ++(\x:\al) node at (\x:\al+0.2) {$x$};
%     \draw [axis] (0,0) -- ++(\y:\al) node at (\y:\al+0.2) {$y$};
%     \draw [axis] (0,0) -- ++(\z:\al) node at (\z:\al+0.2) {$z$};
%     \coordinate (1) at (0,0);    
...
% Intersecting lines
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\a1=30;\a2=140;}
...
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\l1=4;\l2=4;}
%     \draw [green,fill=green!20,opacity=0.5] ($(0,0)+(\x:-1.5)+(\y:-1.5)$) -- ++(\x:4) -- ++(\y:4) -- ++(\x:-4) -- ++(\y:-4);
%     \draw [vector,black] (0,0) coordinate (1) -- ++(\z:2) node [above] {$\vec{n} = \vec{a} \times \vec{b}$};
...
% \begin{tikzpicture}
%     \tikzmath{\x=0;\y=45;\z=90;\a=20;}
%     \draw [green,fill=green!20,opacity=0.5] ($(0,0)+(\x:-2)+(\y:-2)$) -- ++(\x:4) -- ++(\y:4) -- ++(\x:-4) -- ++(\y:-4);
%     \node [point,label=below:$\vec{p}$] (p) {};
%     \node [point,label=below:$\vec{r}$] (r) at (\a:2) {};
%     \draw [vector,black] (0,0) coordinate (1) -- ++(\z:2) node [above] {$\vec{n}$};
%     \draw [vector] (p) -- (r);
