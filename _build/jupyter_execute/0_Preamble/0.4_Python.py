...
# 
# Python is open source software which means it is free to download and install on your home machine. The best we to do this is to visit the website linked to below and download the Individual Edition of the Anaconda suite of programs. Once installed, you can use [Jupyter Notebooks](https://jupyter.org) to run Python commands (this is what you will be using in the programming skills part of the unit) or [Spyder](https://www.spyder-ide.org) which is an Integrated Development Environment (IDE) for Python
# 
