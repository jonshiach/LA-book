...
# 
# In other words $\mathbf{v}$ can be expressed as a linear combination of the vectors $\mathbf{u}_1, \mathbf{u}_2, \ldots$. For example 
# 
# \begin{align*}
...
# 
# \begin{align*}
#     \alpha_1 \mathbf{u}_1 + \alpha_2 \mathbf{u}_2 + \alpha_3 \mathbf{u}_3 &= \mathbf{v} \\
