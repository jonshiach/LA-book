...
# 
# Let $V$ be a vector space over a field $F$ and $W$ a non-empty subset of $V$. We say that $u \in V$ is a **linear combination of elements in $W$** if there exist $v_1, v_2, \ldots, v_n \in W$ and $\alpha_1, \alpha_2, \ldots, \alpha_n \in F$ such that
# 
# ```{math}
# :label: linear-combination-equation
# 
# u = \sum_{i = 1}^n \alpha_i v_i = \alpha_1 v_1 + \alpha_2 v_2 + \ldots + \alpha_n v_n.
# ```
# ````
# 
