...
# 
# - [linear independence property](linear-dependence-definition): for every subset $\{v_1, \ldots , v_n\}$ of $W$ the following equation only has the trivial solution $\alpha_i = 0$.
# 
# \begin{align*}
#     \alpha_1 v_1 + \alpha_2 v_2 + \cdots + \alpha_n v_n &= 0;
# \end{align*}
# 
# - [spanning property](spanning-set-definition): for all $u \in V$ we can write $u$ as a linear combination of $v \in W$, i.e.,
# 
# \begin{align*}
#     u = \alpha_1 v_1 + \alpha_2 v_2 + \cdots + \alpha_n v_n.
# \end{align*}
...
# ````
# 
# Note that in [example 5.8](change-of-basis-example) we can represent any vector $\mathbf{u}$ with respect to the basis $W$ by multiplying by the square matrix in the final equation. This matrix is known as the <a href="https://en.wikipedia.org/wiki/Change_of_basis" target="_blank">**change of basis matrix**</a>.
# 
